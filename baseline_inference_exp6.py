...
if __name__ == "__main__":
    ...
    list_test_texts = [
                        test_data["test_categories"]["short"]*4,
                       test_data["test_categories"]["medium"]*4,
                       test_data["test_categories"]["long"]*3,
                       ]
    
    for test_texts in list_test_texts:
        ...
        #profiler.reset_stats()
        with profiler.profile_section("tts_batch"):
            baseline_results = benchmark_baseline(engine, test_texts, num_runs=10)
